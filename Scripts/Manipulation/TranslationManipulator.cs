...
namespace ArManipulations.Manipulation
{
    ...
    public class TranslationManipulator : Manipulator
    {
        ...
        private ARRaycastHit _lastHit;
		
		
		private ARRaycastManager m_RaycastManager;
		private ARPlaneManager m_PlaneManager;
		private ARAnchorManager m_ReferencePointManager;

		private void Awake()
		{
			m_RaycastManager = FindObjectOfType<ARRaycastManager>();
			m_PlaneManager = FindObjectOfType<ARPlaneManager>();
			m_ReferencePointManager = FindObjectOfType<ARAnchorManager>();
		}
        ...
        protected override void OnContinueManipulation(DragGesture gesture)
        {
            ...
            TransformationUtility.Placement desiredPlacement =
                TransformationUtility.GetBestPlacementPosition(
                    ...
                    MaxTranslationDistance, ObjectTranslationMode, m_RaycastManager, m_PlaneManager);
        ...
        protected override void OnEndManipulation(DragGesture gesture)
        {
			...
			var plane = m_PlaneManager.GetPlane(_lastHit.trackableId);
			var newAnchor = m_ReferencePointManager.AttachAnchor(plane, desiredPose);
